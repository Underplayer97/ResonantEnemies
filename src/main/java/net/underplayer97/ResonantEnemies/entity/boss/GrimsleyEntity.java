...
import net.underplayer97.ResonantEnemies.entity.ai.GrimsleyAttackGoal;
...
public class GrimsleyEntity extends AbstractBossEntity implements IAnimatable {
    ...
    private static final TrackedData<Integer> PRIMARY_ATTACK_COOLDOWN = DataTracker.registerData(GrimsleyEntity.class, TrackedDataHandlerRegistry.INTEGER);
    private static final TrackedData<Integer> SPECIAL_ATTACK_COOLDOWN = DataTracker.registerData(GrimsleyEntity.class, TrackedDataHandlerRegistry.INTEGER);
    public static final TrackedData<Integer> ATTACK_TYPE = DataTracker.registerData(GrimsleyEntity.class, TrackedDataHandlerRegistry.INTEGER);
