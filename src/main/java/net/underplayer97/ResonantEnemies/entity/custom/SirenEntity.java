...
public class SirenEntity extends HostileEntity implements IAnimatable {

    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    protected SirenEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    class AttackGoal extends MeleeAttackGoal {
        public AttackGoal(SirenEntity siren) {
            super(siren, 1.0, false);
        }
