...
public class DrifterEntity extends HostileEntity implements IAnimatable {

    //TODO: MAKE DRIFTER FLY (PARROT AI STUFF)
    //Actually nevermind, it looks good enough


    private final AnimationFactory factory = GeckoLibUtil.createFactory(this);

    public DrifterEntity(EntityType<? extends HostileEntity> entityType, World world) {
