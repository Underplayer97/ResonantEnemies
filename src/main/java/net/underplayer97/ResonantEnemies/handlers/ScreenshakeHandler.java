...
import static net.underplayer97.ResonantEnemies.configs.ResonantConfig.SCREENSHAKE_INTENSITY;
...
public class ScreenshakeHandler {
    ...
    public static void clientTick(Camera camera, Random random) {
        double sum = Math.min(INSTANCES.stream().mapToDouble(i1 -> i1.updateIntensity(camera, random)).sum(), SCREENSHAKE_INTENSITY);
